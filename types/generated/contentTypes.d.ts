...
export interface ApiAuthorAuthor extends Schema.CollectionType {
  ...
  attributes: {
    seo: Attribute.Component<'config.seo'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    open_graph: Attribute.Component<'config.open-graph'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    twitter_card: Attribute.Component<'config.twitter-card'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    custom: Attribute.Component<'config.custom'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    social_media: Attribute.Component<'repeatable.social-media', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPostPost extends Schema.CollectionType {
  ...
  attributes: {
    ...
    content: Attribute.DynamicZone<['base.dynamic-content']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiSettingSetting extends Schema.SingleType {
  ...
  attributes: {
    meta_title_suffix: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    default_category_meta_description: Attribute.Text &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    default_author_meta_description: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
